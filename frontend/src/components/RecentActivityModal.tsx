  ...
  const mockActivities: Activity[] = [
    {
      ...
      description: 'Daily operation fuel consumption',
      operator: 'John Smith'
    },
    {
      id: 2,
      ...
      date: '2024-01-14',
      place: 'Warehouse B',
      description: 'Emergency backup refill',
    ...
    },
    {
      ...
      date: '2024-01-14',
      place: 'Port Terminal',
      description: 'Scheduled maintenance oil change',
      operator: 'Sarah Wilson'
    },
    {
      id: 4,
      type: 'consumption',
      machinery: 'Bulldozer #1',
      amount: '38L',
      date: '2024-01-13',
      place: 'Construction Site A',
      description: 'Site clearing operations',
      operator: 'Tom Davis'
    },
    {
      id: 5,
      ...
      date: '2024-01-13',
      place: 'Mining Site C',
      description: 'Regular fuel refill',
      operator: 'Lisa Brown'
    },
    {
      id: 6,
      type: 'maintenance',
      machinery: 'Generator #2',
      amount: '15L',
      date: '2024-01-12',
      place: 'Warehouse B',
    ...
    },
    {
      ...
      date: '2024-01-12',
      place: 'Port Terminal',
      description: 'Cargo loading operations',
      operator: 'Emma Taylor'
    },
    {
      id: 8,
      type: 'refill',
      machinery: 'Bulldozer #2',
      amount: '110L',
      date: '2024-01-11',
